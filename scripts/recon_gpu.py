...
NODES_FILE = "data/input_txt/nonsmooth_geometry/Cylinder_nodes.txt"    # node文件路径
NORMALS_FILE = "data/input_txt/nonsmooth_geometry/Cylinder_normals.txt"  # normal文件路径
PATCHES_FILE = "data/input_txt/nonsmooth_geometry/Cylinder_patches.txt"  # patch文件路径
